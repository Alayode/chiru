...
//working with nodemailer requirements
var agenda = require('agenda')({ db: { address: 'localhost:27017/test' } });
var sugar = require('sugar');
var nodemailer = require('nodemailer');
var _ = require('lodash');

// var db = 'localhost:27017/test';
...
//==================================================
    //New Code for songs
// grab all the collections from the songs collection.
...
app.post('/api/songs/', function (req, res) {
    var ongaku = req.body.songName;
    songs.insert('name',ongaku);
